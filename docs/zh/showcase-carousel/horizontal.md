<demo vue="../packages/components/src/showcase-carousel/horizontal.vue" react="../packages/components/src/showcase-carousel/horizontal.tsx" title="水平展柜式跑马灯" />
...
<demo vue="example/showcase-carousel/horizontal/horizontal-simple-demo.vue" react="example/showcase-carousel/horizontal/horizontal-simple-demo.tsx" title="水平展柜式跑马灯 - 简单示例" />

## 完整示例
下面示例展示完整的用法

<demo vue="example/showcase-carousel/horizontal/horizontal-full-demo.vue" react="example/showcase-carousel/horizontal/horizontal-full-demo.tsx" title="水平展柜式跑马灯 - 完整示例" />
