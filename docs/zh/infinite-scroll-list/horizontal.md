<demo vue="../packages/components/src/infinite-scroll-list/horizontal.vue" react="../packages/components/src/infinite-scroll-list/horizontal.tsx" title="水平无缝循环滚动的列表"/>
...
<demo vue="example/infinite-scroll-list/horizontal/horizontal-simple-demo.vue" react="example/infinite-scroll-list/horizontal/horizontal-simple-demo.tsx" title="水平无缝循环滚动的列表-简单示例"/>

## 不规则条目

有时候，您可能需要让单个的条目宽度不一致，这在容器中是允许的，您可以单独设置条目的样式或者让条目的宽度保持适应。

<demo vue="example/infinite-scroll-list/horizontal/horizontal-flex-demo.vue" react="example/infinite-scroll-list/horizontal/horizontal-flex-demo.tsx" title="水平无缝循环滚动的列表-不规则条目示例"/>
...
```vue
default：用于渲染行内容。默认获取的行内容会填充到容器宽度使其能够保持滚动。
```
